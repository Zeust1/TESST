...
const Movieshop = () => {
    ...
    const [bannerInfo, setBannerInfo] = useState(defaultBanner)

    const handleSelect = (e) => {
        const id = e.target.id
        if(id){
            const newBanner = list.find((item) => item.id == id) 
            setBannerInfo(newBanner)
        }
    }
  ...
  return (
    <div className='movie-shop'>
        ...
        <Movielist movieList={movieList} handleSelect={handleSelect}/>
    </div>
  )
}
